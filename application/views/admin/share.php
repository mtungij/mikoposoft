...
<?php endif; ?>           
						...
						<div class="card flex flex-col max-sm:mb-[30px] profile-card">
                            <h4 class="ml-4 px-4 pt-2">Register Shareholders</h4>
                            <hr>
								...
								<div class="sm:p-10 sm:pb-2.5 p-[25px] pb-0">
									<div class="row">
										<div class="sm:w-1/2 w-full mb-[30px]">
											<label class="text-dark dark:text-white text-[13px] mb-2"><small class="text-danger">*</small>Shareholder Name</label>
											<input type="text" placeholder="Shareholder Name" name="share_name" class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full" required>
                                            <input>
										</div>
										<div class="sm:w-1/2 w-full mb-[30px]">
											<label class="text-dark dark:text-white text-[13px] mb-2"><small class="text-danger">*</small>Phone Number</label>
											<input type="number" name="share_mobile" placeholder="Enter phone number" class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full"required>
										</div>
							...
							<div class="card-body p-0">
								<div class="overflow-x-auto active-projects">
									<div class="sm:p-5 p-4">
                                        <h4 class="text-base">shareholder List</h4>
									</div>
									<table id="example" class="table w-full ">
										<thead>
											<tr>
												...
												<th class="bg-primary-light text-[13px] py-2.5 px-4 text-primary capitalize border-b border-b-color font-medium bg-none whitespace-nowrap text-left">Shareholder Phone Number</th>
												<th class="bg-primary-light text-[13px] py-2.5 px-4 text-primary capitalize border-b border-b-color font-medium bg-none whitespace-nowrap text-left">Action</th>
                                        ...
                                        <?php foreach ($share as $shareholder): ?>
												...
												<td class="text-[13px] font-normal uppercase text-body-color py-2.5 pl-4 pr-0 whitespace-nowrap border-b border-[#E6E6E6] dark:border-[#ffffff1a]"><?= $shareholder->share_name ?></td>
												<td class="border-b border-[#E6E6E6] dark:border-[#ffffff1a] text-[13px] text-body-color py-2.5 px-5 font-normal whitespace-nowrap"><?= ($shareholder->share_mobile)?></td>
                                            ...
                                            <td class="border-b border-[#E6E6E6] dark:border-[#ffffff1a] text-right py-2.5 px-5 whitespace-nowrap">
												<div class="md:w-1/4 sm:w-1/3 w-1/2">
                                                    <div class="dropdown custom-dropdown inline-block mb-4">
                                                        <div class="btn min-w-[2.4rem] p-[0.4375rem] h-[2.4rem] leading-[1.7] min-h-[2.5rem] btn-primary tp-btn ml-4 hover:bg-primary rounded-md dz-dropdown" data-dz-dropdown="<?php echo $shareholder->share_id ?>">
                                                        ...
                                                        <div class="dz-dropdown-menu absolute translate-x-[-167px] translate-y-2.5 overflow-hidden rounded-md z-[9] bg-white dark:bg-[#182237] shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] min-w-[13rem] text-left py-2 hidden" id="<?php echo $shareholder->share_id ?>">
