...
<?php endif; ?>           
						...
						<div class="card flex flex-col max-sm:mb-[30px] profile-card">
                            <h4 class="ml-4 px-4 pt-2">Create Loan Product</h4>
                            <hr>
								...
								<div class="sm:p-10 sm:pb-2.5 p-[25px] pb-0">
									<div class="row">
										<div class="sm:w-1/2 w-full mb-[30px]">
											<label class="text-dark dark:text-white text-[13px] mb-2"><small class="text-danger">*</small>Loan Product Name</label>
											<input type="text" placeholder="Enter loan product Name" name="loan_name" class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full" required>
                                            <input>
										</div>
										<div class="sm:w-1/2 w-full mb-[30px]">
											<label class="text-dark dark:text-white text-[13px] mb-2"><small class="text-danger">*</small>Minimum Loan Amount</label>
											<input type="number" name="loan_price" class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full"required>
										</div>
										<div class="sm:w-1/2 w-full mb-[30px]">
											<label class="text-dark dark:text-white text-[13px] mb-2"><small class="text-danger">*</small>Maximum Loan Amount</label>
											<input type="number" name="loan_perday" class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full" required>
										</div>
										<div class="sm:w-1/2 w-full mb-[30px]">
											<label class="text-dark dark:text-white text-[13px] mb-2"><small class="text-danger">*</small>Loan Product Interest</label>
											<input type="" name="interest_formular" class="form-control relative text-[13px] text-body-color h-[2.813rem] border border-b-color block rounded-md py-1.5 px-3 duration-500  outline-none w-full"required>
										</div>
