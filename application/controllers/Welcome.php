   ...
   // user sing in
		...
		if ($userexit){
				if ($userexit->role == 'admin') {
                    ...
                    $this->session->set_flashdata('blocked','Your account has been blocked Please contact support for assistance.');
					$this->load->view("home/login");  	
                      }elseif ($userexit->comp_status == 'open') {
                    $this->session->set_userdata($sessionData);
                    $this->session->set_flashdata('successfully','You Login successsfuly');
				...
				$this->session->set_flashdata('failed','invalid Phone number or password please try again');
				$this->load->view("home/login");
			}
		}
		else{
	...
	public function Employee_signin(){
		...
		if ($userexit){
			   ...
			   //             exit();
                    ...
                    $this->session->set_userdata($sessionData);
                    $this->session->set_flashdata('mass','System is Blocked Please Contact with System Adminstrator ');
                    ...
                    $this->session->set_userdata($sessionData);
                    $this->session->set_flashdata('mass','Your Account is Please Contact with System Adminstrator');
					return redirect("welcome/employee_login");
                      }
        ...
        //      exit();
                   ...
                   $this->session->set_flashdata('massage','Log in successsfuly');
                    ...
                    $this->session->set_userdata($sessionData);
                    $this->session->set_flashdata('mass','Your Account is Blocked Please Contact with System Adminstrator ');
				  return redirect("welcome/employee_login");
                      }
				...
				$this->session->set_flashdata('mass','Your Phone number or password is Invalid');
				return redirect("welcome/employee_login");
			}
		}
		else{
